...
func (s *StateTransitionPubSignals) VerifyStates(ctx context.Context, stateVerFunc StateResolverFunc) error {
	stateInfo, err := stateVerFunc(ctx, s.UserID.BigInt(), s.NewUserState.BigInt())
	if err != nil {
		return err
	}
	if stateInfo == nil {
