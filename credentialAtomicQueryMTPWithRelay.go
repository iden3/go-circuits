...
const (
	...
	AtomicQueryMTPWithRelayPublicSignalsSchema PublicSchemaJSON = `{"id":0, "reIdenState":1,"challenge":2,"claimSchema":3,"slotIndex":4,"operator":5,"value":6,"timestamp":7, "issuerID":8}`
...
func (c *AtomicQueryMTPWithRelay) prepareAuthClaimInputs(in *AtomicQueryMTPWithRelayInputs) (map[string]interface{}, error) {
	...
	// Note: we don't setup inputs["hoIdenState"] = in.CurrentStateTree.StateStr() here
