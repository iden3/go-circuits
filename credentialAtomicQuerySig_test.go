...
func TestAttrQuerySig_PrepareInputs(t *testing.T) {
	...
	claimIssuerSignature := ClaimIssuerSignature{
		ID:                 issuerIdentity,
		Signature:          claimSignature,
		AuthClaimTreeState: issuerAuthTreeState,
		AuthClaimProof:     mtpAuthIssuer,
		AuthClaimHi:        hIndexAuthEntryIssuer,
		AuthClaimHv:        hValueAuthEntryIssuer,
		AuthClaimPubKeyX:   issuerKey.Public().X,
		AuthClaimPubKeyY:   issuerKey.Public().Y,
	}
