...
func (q Query) Check(
	...
	// 	return err
	// }
	// if pubSig.Operator == circuits.NULLIFY {
	// 	if err = verifyNullify(1, 1, pubSig.ClaimSchema.BigInt(), pubSig.Value[0], pubSig.VerifierID.BigInt(), pubSig.Value[0], pubSig.OperatorOutput); err != nil {
	// 		return err
	// 	}
	// }
