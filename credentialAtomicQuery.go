...
const (
	...
	AtomicQueryPublicSignalsSchema PublicSchemaJSON = `{"challenge":0,"user_identifier":1,"hoIdenState":2,"claimSchema":3,"slotIndex":4,"operator":5,"value":6,"timestamp":7,"queryOut":8}`
